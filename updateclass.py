...
#    Jan 02, 2020 11:54:17 PM CST  platform: Windows NT
...
import updateclass_support

def vp_start_gui(cno,cname,credit):
    '''Starting point when module is the main routine.'''
    global cno1,cname1,credit1
    cno1 = cno
    cname1 = cname
    credit1 = credit
    global val, w, root
    root = tk.Tk()
    top = Toplevel1 (root)
    updateclass_support.init(root, top)
    root.mainloop()
...
def create_Toplevel1(root, *args, **kwargs):
    ...
    w = tk.Toplevel (root)
    top = Toplevel1 (w)
    updateclass_support.init(w, top, *args, **kwargs)
    return (w, top)
...
class Toplevel1:
    def __init__(self, top=None):
        ...
        self.Button1.configure(command=updateclass_support.updates)
        ...
        self.Button1_1.configure(command=updateclass_support.comeback)
        ...
        self.Label1_2 = tk.Label(top)
        self.Label1_2.place(relx=-0.106, rely=1.667, height=46, width=125)
        self.Label1_2.configure(activebackground="#f9f9f9")
        self.Label1_2.configure(activeforeground="black")
        self.Label1_2.configure(background="#d9d9d9")
        self.Label1_2.configure(disabledforeground="#a3a3a3")
        ...
        self.Label1_2.configure(highlightbackground="#d9d9d9")
        self.Label1_2.configure(highlightcolor="black")
        self.Label1_2.configure(text='''大学物理''')
        ...
        self.Label1_3.configure(text='''学分''')
